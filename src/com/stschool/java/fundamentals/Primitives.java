...
public class Primitives {
    public static void main(String[] args0) {
        ...
        aadhaarNumber = 746675649854L;
        accountNumber = 7458746563487567348L;
        population = 85487589775L;
        netWorth = 845846565765L;
        ...
        uiVersion = 14.2F;
        displaySize = 7.2F;
        engineTemperature = 110.4F;
        bluetoothVersion = 4.3F;
        ...
        coordinates = 73568.34874;
        piValue = 3.1415887348;
        bloodSugarLevel = 67.867;
        networkLatency = 0.704;
        executionTime = 0.0045;
